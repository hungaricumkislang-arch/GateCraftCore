...
@DesignerComponent(version=3, description="Offline GateCraft MotorDiag controller recognition core with bundled image OCR and one-call image identification, 12-language and 4-theme contract.", category=ComponentCategory.EXTENSION, nonVisible=true, iconName="")
...
public class GateCraftMotorVision extends AndroidNonvisibleComponent {
  ...
  @SimpleFunction
  public String Version(){return "1.3.0-phase2l";}
  @SimpleFunction
  ...
  public void RecognizeAndIdentifyImage(String imagePath){
    if(!IndexLoaded()){
      lastError=UiText("index_not_loaded");
