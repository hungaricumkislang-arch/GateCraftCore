...
@DesignerComponent(version=4, description="Offline GateCraft MotorDiag controller recognition core with bundled image OCR, one-call image identification, and GateCraft MD_INDEX asset loading.", category=ComponentCategory.EXTENSION, nonVisible=true, iconName="")
...
public class GateCraftMotorVision extends AndroidNonvisibleComponent {
  ...
  @SimpleFunction
  public String Version(){return "1.4.0-phase2m";}
  @SimpleFunction
