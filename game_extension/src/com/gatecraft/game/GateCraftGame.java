...
@DesignerComponent(
    version = 7,
    description = "GateCraft Arcade Suite v5.0: full-screen landscape 90s arcade depth update for Workshop Run, Heroes of Craft & Gates and Metal Fighter with richer game loops, enemies, fog-of-war strategy, best-of-three fighting, multi-touch and lazy memory release.",
...
public class GateCraftGame extends AndroidNonvisibleComponent implements OnPauseListener, OnResumeListener, OnDestroyListener {
  ...
  int getCalculationCount(){return calculationCount;}boolean isTestMode(){return testMode;}int getLanguage(){return language;}
  ...
  @SimpleFunction(description="Returns extension version.") public String Version(){return "5.0.0";}
